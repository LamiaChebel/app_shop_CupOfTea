...
//Update
adminRouter.put("/api/v1/cupoftea/packsteas/packaging/:p_id/tea/:t_id", updatePackTea);

//Delete
adminRouter.delete("/api/v1/cupoftea/packsTeas/packaging/:p_id/tea/:t_id", removePackTea);
